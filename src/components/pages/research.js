            ...
            <Container>
                <Row>
                    ...
                    <Col md={4} xs={12} style={pad}>
                        ...
                        <ListGroup variant="flush">
                            <ListGroup.Item><a href="https://ieeexplore.ieee.org/abstract/document/9405359" target="_blank">
                                Clickbait-Trust and Credibility of Digital News, IEEE Transactions on Technology and Society, 2021</a></ListGroup.Item>
                            <ListGroup.Item><a href="https://aclanthology.org/2020.icon-main.11.pdf" target="_blank">
                                Clickbait in Hindi News Media, International Conference on Natural Language Processing (ICON'20), 2020</a></ListGroup.Item>
                            <ListGroup.Item><a href="https://www.researchgate.net/profile/Vivek-Kaushal-3/publication/345156547_Investigating_Academic_Performance_and_Financial_Risk-Taking/links/5f9fa924a6fdccfd7b948b85/Investigating-Academic-Performance-and-Financial-Risk-Taking.pdf" target="_blank">
                            ...
                            <ListGroup.Item><a href="https://www.trembling-hand.com/wp-content/uploads/2021/03/measuring-consumer-freedom.pdf" target="_blank">
                ...
                <Row>
                    ...
                    <Col md={4} xs={12} style={pad}>
                        <h3>Links</h3>
                        <ListGroup variant="flush">
                            <ListGroup.Item><a href="https://drive.google.com/file/d/1Y0A-_eBY-tySBg82vUveCIcCU8T3-LXx/view?usp=sharing" target="_blank">
                                Research Resume</a></ListGroup.Item>
                            <ListGroup.Item><a href="https://scholar.google.co.in/citations?user=juZg-YcAAAAJ&hl=en" target="_blank">
                                Google Scholar</a></ListGroup.Item>
                            <ListGroup.Item><a href="https://www.researchgate.net/profile/Vivek-Kaushal-3" target="_blank">
                                ResearchGate</a></ListGroup.Item>
                            <ListGroup.Item><a href="https://kaggle.com/kaushalvivek/datasets" target="_blank">
